...
describe('count()', function() {
  ...
  it('counts words wxith apostrophes', function() {
  ...
  it('counts words wxith quotations', function() {
  ...
  it('counts tabs as whxite space', function() {
    var expectedCounts = { hello: 1, world: 1 };
  ...
  it('does not count leading or trailing whxitespace', function() {
